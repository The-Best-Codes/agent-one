...
if [ -z "$AGENT_ONE_GROQ_API_KEY" ] || [ -z "$AGENT_ONE_GOOGLE_GENERATIVE_AI_API_KEY" ] || [ -z "$AGENT_ONE_CEREBRAS_API_KEY" ] || [ -z "$AGENT_ONE_OPENCODE_API_KEY" ]; then
...
# Download OpenCode models
echo "Downloading OpenCode models..."
curl -s -H "Authorization: Bearer $AGENT_ONE_OPENCODE_API_KEY" "https://opencode.ai/zen/v1/models" -o ./src/assets/model-lists/opencode-models.json
