...
export async function POST(req: Request) {
  try {
    ...
    const result = streamText({
      ...
      You will be provided with a topic to research. Your task is to exhaustively investigate every aspect of the topic. Deep research means:

      1. Trying to perform at least 10 searches with varying keywords and search operators, paying close attention to advanced search techniques (like 'site:example.com').
      2. Trying to browse at least 5 different websites, including those that seem tangentially related to the core topic.
      3. Trying to follow at least 3 internal or external links from each browsed page to further explore related information.
