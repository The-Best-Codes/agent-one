        ...
        {isLoading ? (
          ...
          <div className="py-2 flex flex-col w-full">
            <div className="flex items-center">
              <Robot className="w-6 h-6 min-w-6 min-h-6 mr-2 text-gray-500" />
              <p className="text-base font-medium">
                Agent Deployed: {agentName}
              </p>
            </div>
            <p className="text-sm text-gray-500 mt-2">Task: {task}</p>
            <p className="text-sm text-gray-500 mt-1">No results available.</p>
          </div>
        )}
      </div>
    </div>
