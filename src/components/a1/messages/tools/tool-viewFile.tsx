...
import { IconChevronDown, IconCircleCheck, IconCircleX, IconEye, IconX } from "@tabler/icons-react";
  ...
  switch (part.state) {
    ...
    case "input-available": {
      ...
      return (
        ...
        >
          <Spinner className="text-foreground size-4 shrink-0" />
          <span className="max-w-2xl truncate">{`Reading ${filePath}...`}</span>
        </div>
      );
    }
      ...
      return (
        ...
        >
          <AccordionItem
            value={callId}
            className={cn(
              "group/view-file-accordion border-border w-full rounded-md border-0 transition-[padding] duration-200",
            ...
            <AccordionTrigger
              icon={
                <div className="relative">
                  <IconEye
                    className={cn(
                      "text-foreground absolute inset-0 size-4 shrink-0 scale-100 opacity-100 transition-[opacity,scale] duration-200 group-hover/view-file-accordion:scale-0 group-hover/view-file-accordion:opacity-0",
                  ...
                  <IconChevronDown
                    className={cn(
                      "text-foreground absolute inset-0 size-4 shrink-0 scale-0 opacity-0 transition-[opacity,scale] duration-200 group-hover/view-file-accordion:scale-100 group-hover/view-file-accordion:opacity-100",
              ...
              {output.content ? (
                <div className="flex w-full flex-col gap-1">
                  <div className="border-border w-full overflow-hidden rounded border">
                    <ContentPreview content={output.content} filePath={filePath} />
                  </div>
                  {output.truncated && (
...
MessagePartToolViewFile.displayName = "MessagePartToolViewFile";
