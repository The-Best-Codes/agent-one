        ...
        <>
          <Field>
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  {TTS_PROVIDER_OPTIONS.find((provider) => provider.id === "openai")?.voices.map(
                    (voice) => (
      ...
      {ttsSettings.provider === "elevenlabs" ? (
        <>
          ...
          <Field orientation="horizontal">
            <FieldLabel htmlFor="tts-elevenlabs-speaker-boost">Boost Voice Match</FieldLabel>
            <Switch
        ...
        <>
          <Field>
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  {TTS_PROVIDER_OPTIONS.find((provider) => provider.id === "google")?.voices.map(
                    (voice) => (
                      <SelectItem key={voice} value={voice}>
                        {voice}
                      </SelectItem>
