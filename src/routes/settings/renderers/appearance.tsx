...
export default function AppearanceSection({ cardIndex }: { cardIndex?: number } = {}) {
              ...
              >
                {fontOptions.map((option) => (
                  <ToggleGroupItem
                    ...
                    value={option.value}
                    aria-label={
                      { default: "Default", system: "System", mono: "Mono", roboto: "Roboto" }[
                        option.value
                      ]
                    }
              ...
              >
                {roundnessOptions.map((option) => (
                  <ToggleGroupItem
                    ...
                    value={option.value}
                    aria-label={
                      { none: "Not Round", sm: "Slightly Round", md: "Round", lg: "Very Round" }[
                        option.value
                      ]
                    }
                    title={
