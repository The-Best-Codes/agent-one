...
What we need: The AI can take a maximum of 50 steps, calling `stop()` should abort the current tool or response stream and no subsequent tools will be executed, multi-step tool calling (up to 50) works.
